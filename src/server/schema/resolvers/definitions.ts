...
export type GraphQLMutationCreateLifeArgs = {
  life?: InputMaybe<GraphQLCreateLifeInput>;
};
...
export type GraphQLLifeResolvers<ContextType = Context, ParentType extends GraphQLResolversParentTypes['Life'] = GraphQLResolversParentTypes['Life']> = {
...
export type GraphQLMutationResolvers<ContextType = Context, ParentType extends GraphQLResolversParentTypes['Mutation'] = GraphQLResolversParentTypes['Mutation']> = {
  ...
  createLife?: Resolver<GraphQLResolversTypes['Life'], ParentType, ContextType, Partial<GraphQLMutationCreateLifeArgs>>;
